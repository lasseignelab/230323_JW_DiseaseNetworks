...
singularity exec --cleanenv --containall -B ${wd} -B /data/project/lasseigne_lab/DATASET_dir/TCGA_GTEx_CCLE_HPA_220807/gtex/ /data/user/jbarham3/230323_JW_DiseaseNetworks/bin/docker/jw_diseasenetworks_1.0.0.sif Rscript --vanilla ${src}/PANDA.R ${INPUT} # here vanilla ensures only the script is run and environment is kept clean