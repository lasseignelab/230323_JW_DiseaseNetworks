...
TF targeting score, a numerical score representing the extent to which a TF is targeting genes in a given biological context. The TF targeting score is calculated by summing the weights of all inbound regulatory edges for a gene (https://doi.org/10.3389/fgene.2021.649942). 
